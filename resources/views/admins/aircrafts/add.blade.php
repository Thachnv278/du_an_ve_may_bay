...
@endif
   ...
   <div class="card-body">
    ...
    <form action="{{ route('aircrafts.add') }}" method="post">
      @csrf
      <div class="row mb-3">
          <label class="col-sm-2 col-form-label">Tên Máy Bay</label>
          <div class="col-sm-10">
              <input type="text" class="form-control" name="aircraft_name">
          </div>
      </div>
      <div class="row mb-3">
      ...
      <div class="row mb-3">
          ...
          <div class="col-sm-10">
              <input type="text" class="form-control" name="seat_count_type_1" id="seat_count_type_1">
          </div>
      </div>
      <div class="row mb-3">
      ...
      <div class="row mb-3">
          ...
          <div class="col-sm-10">
              <input type="text" class="form-control" name="seat_count_type_2" id="seat_count_type_2">
          </div>
      </div>
      <div class="row mb-3">
          <label class="col-sm-2 col-form-label">Sức Chứa</label>
          <div class="col-sm-10">
              <input type="text" class="form-control" name="seating_capacity" id="seating_capacity" readonly>
          </div>
      </div>
