...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('../admins/assets/vendor/fonts/boxicons.css') }}" />
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item active">
                        <a href="{{ route('flights.index') }}" class="menu-link">
                            ...
                            <div data-i18n="Analytics">Chuyến Bay</div>
                        </a>
                    </li>
                    <!-- Layouts -->
                    <li class="menu-item">
                        <a href="{{ route('routes.index') }}" class="menu-link ">
                            ...
                            <div data-i18n="Layouts">Lộ Trình Bay</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('aircrafts.index') }}" class="menu-link ">
                            <i class="menu-icon tf-icons bx bx-layout"></i>
                            <div data-i18n="Layouts">Máy Bay</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="{{ route('passengers.index') }}" class="menu-link ">
                            <i class="menu-icon tf-icons bx bx-layout"></i>
                            <div data-i18n="Layouts"> Hành Khách</div>
                        </a>
                    </li>
                    {{-- <li class="menu-item">
                        <a href="{{ route('tickets.index') }}" class="menu-link ">
                            <i class="menu-icon tf-icons bx bx-layout"></i>
                            <div data-i18n="Layouts"> Vé Máy Bay</div>
                        </a>
                    </li> --}}
                    <li class="menu-item">
                        <a href="{{ route('bookings.index') }}" class="menu-link ">
                            <i class="menu-icon tf-icons bx bx-layout"></i>
                            <div data-i18n="Layouts"> Hóa đơn</div>
                        </a>
                    </li>
                </ul>
            </aside>
