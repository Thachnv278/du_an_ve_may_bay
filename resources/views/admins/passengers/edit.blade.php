...
@endif
   <div class="card-header d-flex align-items-center justify-content-between">
     <h5 class="mb-0">Sửa Hành Khách</h5>
   ...
   <div class="card-body">
     ...
     <form action="{{route('passengers.edit', $passenger->id)}}" method="post">
      @csrf
       <div class="row mb-3">
       ...
       <div class="row mb-3">
         ...
         <div class="col-sm-10">
           <input type="date" class="form-control" name="date_of_birth" value="{{$passenger->date_of_birth}}">
         </div>
       </div>
